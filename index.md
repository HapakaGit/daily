...
안녕하세요!  현재 KBS 미디어에서 웹개발자로 일 하고 있는 하파카 입니다! 현재 KBS 비방송 사이트와 PC 버전 라디오 콩을 담당하여 개발 하고 있습니다.

주로 사용하는 프로그래밍 언어는  JS, react, angular, jquery, php, JAVA spring framework,electron framework 이고, AWS 클라우드 시스템에서 개발하고 있습니다. 

배우는 것을 좋아하고, 새로운 트렌드에 관심 있는 프론트엔드 개발자로써 사람들과 소통하기 위해 블로그를 만들었습니다. 앞으로 많은 블로그 포스팅을 통해 지식을 나누고, 같이 소통하고 싶습니다! :)

{% include button.html text="깃허브" icon="github" link="https://github.com/hapakacode" color="#272928" %} {% include button.html text="링크드인" icon="linkedin" link="https://www.linkedin.com/in/%EC%9C%A0%EC%A7%84-%ED%95%98-798290151/" color="#0366d6" %} {% include button.html text="일상 블로그" link="https://hapaka.tistory.com/" color="#db750f" %} 
...
* 신규 라디오 어플리케이션 개발 작업(2018.07~)
  * Electron Framework 를 사용하여 pc 버전 라디오 웹앱(KONG) 개발
  * 추가 신규 기능 개발 및 유지보수
  * 주요내용: 라디오 온에어 스트리밍, 채팅 개발
  * 사용 기술: Electron framework, React, Node JS, API

* KBS 인프라 클라우드 이전으로 홈페이지 이전 작업 (2018.03 ~ 2019.12)
  * 내부 인프라 IDC 에서 AWS 클라우드로 이전하면서 필요한 웹 내부 이전 처리 작업 및 이전시 필요한 서비스 체크, 장애 대응

* KBS비방송 홈페이지 유지보수 (2019.01~)
  * 내부 클라우드 이전으로 신규 생성된 비방송 홈페이지 유지보수
  * 홈페이지와 연결되는 어드민 페이지 유지보수 개발 작업
  * 필요한 신규 기능 개발
  * 지역국 사이트 내 VOD 다시보기, 뉴스 시스템 개발
  * 해당 홈페이지: KBS 지역국(local.kbs.co.kr), KBS 소개(open.kbs.co.kr) 등
  * 사용 기술: Html, php, JS (angular, jquery, handlebar, grunt, webpack, node js), JAVA Spring framework, aws S3, aws ec2 리눅스 서버 관리

<br>

## 학력 
---------------------------------------------------------
#### 컴퓨터 사이언스 학과, 오클랜드 대학교 (뉴질랜드) 
<small>2016.02 — 2017.09</small>

#### 광전자 학과, 오클랜드 대학교 (뉴질랜드) 
<small>2014.02 – 2015.11</small>
...
## 인턴 
---------------------------------------------------------
#### 한국 내쇼날 인스트루먼트 캠퍼스 인턴
<small>2017.01 — 2017.02</small>
...
* 랩뷰
  ...
  * CLAD 자격증 획득
* 자동화 시스템 개발
  * Labview 와 DAQ 를 사용 하여 자동화 시스템 개발 (탁구 자동 채점기)
  * 해당 제품 개발 후 프레젠테이션 진행
  * 최종 Outstanding Intern 수상
  
#### 한국 구글 스터디잼 참여 (코세라, 퀵랩)
<small>2019.01 — 2019.04</small>

* 쿠버네틱스 관련 교육 수료
* 머신러닝 관련 교육 수료

#### 뉴질랜드 MSA 인턴쉽 프로그램 참여
<small>2016.08 — 2016.12</small>

* Azure Cloud 사용 하여 웹, 앱 기획 및 개발
  * 웹 언어를 사용한 웹 홈페이지 개발 및 Azure 배포
* 모바일 앱 개발
  * Visual Studio Xarmarin 과 Bot framework 를 사용하여 모바일 앱 개발
